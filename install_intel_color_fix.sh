...
echo "⚠️  Use it at your own risk — I am NOT responsible if it breaks anything."
echo "🧾 This script is adapted from the Arch Wiki: https://wiki.archlinux.org/title/Intel_graphics#Fix_colors_for_Wayland"
echo ""
